...
const rangeSize = 100;
  ...
  const selectedEpisodes =  episodes && episodes.slice(startIndex, endIndex);
    ...
    try {
      const res = await axios.get(`https://juanito66.vercel.app/meta/anilist/info/${id}`);
      ...
      setDetail2(res.data);
            setError(null);
              ...
              console.log(`https://juanito66.vercel.app/api/v2/info/${id}`);
  ...
  try {
    ...
    const res = await axios.get(`https://juanito66.vercel.app/meta/anilist/episodes/${id}`);
    ...
    console.log(`https://juanito66.vercel.app/anime/episodes/${id}`);
  } catch (error) {
